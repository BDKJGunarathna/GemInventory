...
public class DashboardController implements Initializable {
    ...
    public void fhomeOnAction(ActionEvent event){
        ...
        try {
            ...
            Stage home2 = (Stage) btnhomjewlery.getScene().getWindow();
            home2.setTitle("City of Gems");
            home2.setScene(new Scene(root, 1250,800));
            home2.show();
        }catch (Exception e){
            e.printStackTrace();
        }
...
*/
    ...
    @FXML
    public void btnhomSupOnAction(ActionEvent event) throws IOException {
        btnhomSup.getScene().getWindow().hide();

        Stage stage = new Stage();
        Parent parentRoot1 = FXMLLoader.load(getClass().getResource("/supplierManagement/newPurchaseOrder.fxml"));
        Scene sceneSupp = new Scene(parentRoot1);
        stage.setScene(sceneSupp);
        stage.show();
