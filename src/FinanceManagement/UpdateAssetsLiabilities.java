...
public class UpdateAssetsLiabilities {
    ...
    public UpdateAssetsLiabilities(Integer assetsliabilities_id, String assetsliabilities_description, String assetsliabilities_type, Date assetsliabilities_date, Double assetsliabilities_amount) {
