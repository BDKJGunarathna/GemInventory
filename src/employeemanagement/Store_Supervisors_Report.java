...
public class Store_Supervisors_Report {
    //declare variables
    private String HTML;
    ...
    public Store_Supervisors_Report() throws SQLException {
        ...
        query = "SELECT empID, empName, empDOB, empAddress, nic_number, empPhone1, empPhone2, empEmail FROM employeemanagement_table WHERE empType='Store Supervisor'";
        ...
        HTML =  "<h1 style='color: #2196f3; text-align: center;'>CITY OF GEMS</h1>"+
                "<h3 style='text-align: center'>Store Supervisors</h3>"+
    ...
    public void createPdf(){
        try{
            //Convert HTML to PDF
            //PDF Name : Store_Supervisors_Report.pdf
            HtmlConverter.convertToPdf(HTML, new FileOutputStream("Store_Supervisors_Report.pdf"));
