...
public class Quality_Checkers_Report {
    //declare variables
    private String HTML;
    ...
    public Quality_Checkers_Report() throws SQLException {
        ...
        query = "SELECT empID, empName, empDOB, empAddress, nic_number, empPhone1, empPhone2, empEmail FROM employeemanagement_table WHERE empType='Quality Checker'";
        ...
        HTML =  "<h1 style='color: #2196f3; text-align: center;'>CITY OF GEMS</h1>"+
                "<h3 style='text-align: center'>Quality Checkers</h3>"+
    ...
    public void createPdf(){
        try{
            //Convert HTML to PDF
            //PDF Name : Quality_Checkers_Report.pdf
            HtmlConverter.convertToPdf(HTML, new FileOutputStream("Quality_Checkers_Report.pdf"));

            //Alert Information box
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setHeaderText(null);
            alert.setContentText("Quality Checkers Report Successfully Downloaded");
            alert.show();
