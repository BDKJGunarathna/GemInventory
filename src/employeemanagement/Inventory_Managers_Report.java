...
public class Inventory_Managers_Report {
    //declare variables
    private String HTML;
    ...
    public Inventory_Managers_Report() throws SQLException {
        ...
        query = "SELECT empID, empName, empDOB, empAddress, nic_number, empPhone1, empPhone2, empEmail FROM employeemanagement_table WHERE empType='Inventory Manager'";
        ...
        HTML =  "<h1 style='color: #2196f3; text-align: center;'>CITY OF GEMS</h1>"+
                "<h3 style='text-align: center'>Inventory Managers</h3>"+
    ...
    public void createPdf(){
        try{
            //Convert HTML to PDF
            //PDF Name : Inventory_Managers_Report.pdf
            HtmlConverter.convertToPdf(HTML, new FileOutputStream("Inventory_Managers_Report.pdf"));

            //Alert Information box
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setHeaderText(null);
            alert.setContentText("Inventory Managers Report Successfully Downloaded");
            alert.show();
