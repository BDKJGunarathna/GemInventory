...
public class Admin_Assistants_Report {
    //declare variables
    private String HTML;
    ...
    public Admin_Assistants_Report() throws SQLException {
        ...
        query = "SELECT empID, empName, empDOB, empAddress, nic_number, empPhone1, empPhone2, empEmail FROM employeemanagement_table WHERE empType='Administrative Assistant'";
        ...
        HTML =  "<h1 style='color: #2196f3; text-align: center;'>CITY OF GEMS</h1>"+
                "<h3 style='text-align: center'>Administrative Assistants</h3>"+
    ...
    public void createPdf(){
        try{
            //Convert HTML to PDF
            //PDF Name : Administrative_Assistants_Report.pdf
            HtmlConverter.convertToPdf(HTML, new FileOutputStream("Administrative_Assistants_Report.pdf"));
