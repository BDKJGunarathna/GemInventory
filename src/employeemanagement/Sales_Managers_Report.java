...
public class Sales_Managers_Report {
    ...
    public Sales_Managers_Report() throws SQLException {
        ...
        query = "SELECT empID, empName, empDOB, empAddress, nic_number, empPhone1, empPhone2, empEmail FROM employeemanagement_table WHERE empType='Sales & Administrator Manager'";
        ...
        HTML =  "<h1 style='color: #2196f3; text-align: center;'>CITY OF GEMS</h1>"+
                "<h3 style='text-align: center'>Sales & Administrator Managers</h3>"+
    ...
    public void createPdf(){
        try{
            //Convert HTML to PDF
            //PDF Name : Sales_Managers_Report.pdf
            HtmlConverter.convertToPdf(HTML, new FileOutputStream("Sales_Managers_Report.pdf"));

            //Alert Information box
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setHeaderText(null);
            alert.setContentText("Sales Managers Report Successfully Downloaded");
            alert.show();
