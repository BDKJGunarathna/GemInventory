...
public class Suspended_Employee_List_Report {
    //declare variables
    private String HTML;
    ...
    public Suspended_Employee_List_Report() throws SQLException {
        ...
        query = "SELECT empID, empName, empType, empSalary FROM employeemanagement_table WHERE empSuspend = 'YES'";
        ...
        HTML =  "<h1 style='color: #2196f3; text-align: center;'>CITY OF GEMS</h1>"+
                "<h3 style='text-align: center'>Suspended Employee Report</h3>"+
    ...
    public void createPdf(){
        try{
            ...
            HtmlConverter.convertToPdf(HTML, new FileOutputStream("Suspended_Employee_List_Report.pdf"));
