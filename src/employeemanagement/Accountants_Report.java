...
public class Accountants_Report {
    //declare variables
    private String HTML;
    ...
    public Accountants_Report() throws SQLException {
        ...
        query = "SELECT empID, empName, empDOB, empAddress, nic_number, empPhone1, empPhone2, empEmail FROM employeemanagement_table WHERE empType='Accountant'";
        ...
        HTML =  "<h1 style='color: #2196f3; text-align: center;'>CITY OF GEMS</h1>"+
                "<h3 style='text-align: center'>Accountants</h3>"+
    ...
    public void createPdf(){
        try{
            //Convert HTML to PDF
            //PDF Name : Accountants_Report.pdf
            HtmlConverter.convertToPdf(HTML, new FileOutputStream("Accountants_Report.pdf"));

            //Alert Information box
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setHeaderText(null);
            alert.setContentText("Accountants Report Successfully Downloaded");
            alert.show();
