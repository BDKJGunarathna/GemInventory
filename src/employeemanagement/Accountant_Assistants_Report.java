...
public class Accountant_Assistants_Report {
    //declare variables
    private String HTML;
    ...
    public  Accountant_Assistants_Report() throws SQLException {
        ...
        query = "SELECT empID, empName, empDOB, empAddress, nic_number, empPhone1, empPhone2, empEmail FROM employeemanagement_table WHERE empType='Accountant Assistant'";
        ...
        HTML =  "<h1 style='color: #2196f3; text-align: center;'>CITY OF GEMS</h1>"+
                "<h3 style='text-align: center'>Accountant Assistants</h3>"+
    ...
    public void createPdf(){
        try{
            //Convert HTML to PDF
            //PDF Name : Accountant_Assistants_Report.pdf
            HtmlConverter.convertToPdf(HTML, new FileOutputStream("Accountant_Assistants_Report.pdf"));

            //Alert Information box
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setHeaderText(null);
            alert.setContentText("Account Assistants Report Successfully Downloaded");
            alert.show();
