...
public class Admins_Report {
    ...
    public Admins_Report() throws SQLException {
        ...
        query = "SELECT empID, empName, empDOB, empAddress, nic_number, empPhone1, empPhone2, empEmail FROM employeemanagement_table WHERE empType='Admin'";
    ...
    public void createPdf(){
        try{
            //Convert HTML to PDF
            //PDF Name : Admins_Report.pdf
            HtmlConverter.convertToPdf(HTML, new FileOutputStream("Admins_Report.pdf"));

            //Alert Information box
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setHeaderText(null);
            alert.setContentText("Admins Report Successfully Downloaded");
            alert.show();
